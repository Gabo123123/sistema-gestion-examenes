...
interface MenuItem { id:string; path:string; label:string; icon:string; }

export default function Sidebar() {
  const menuItems: MenuItem[] = [
    { id:'dashboard', path:'/dashboard', label:'Inicio Demo', icon:'home' },
    { id:'procesos', path:'/procesos', label:'Procesos de Examen', icon:'assignment' },
    ...
    <aside className="sidebar">
      <div className="logo-container">
        ...
        <div>
          ...
          <span style={{ display:'inline-block', marginTop:5, fontSize:10, fontWeight:700, color:'#1a73e8', letterSpacing:'.06em' }}>DEMO INSTITUCIONAL</span>
        </div>
      </div>
      ...
      <div style={{ marginTop:'auto', padding:'14px 10px 0', borderTop:'1px solid #eef0f2', fontSize:11, lineHeight:1.5, color:'#80868b' }}>
        Los datos de esta demo se guardan localmente en el navegador.
      </div>
    </aside>
  );
}
